...
```{r stepshist, cache=TRUE, fig.width=5, fig.height=4}
...
```{r dailyinterval, cache=TRUE,  fig.width=5, fig.height=4}
data.interval <-
    data.raw %>% 
    group_by(interval) %>%
...
```{r histcomplete, cache=TRUE,  fig.width=5, fig.height=4}
data.daily.complete <-
    data.complete %>% 
    group_by(date) %>%
...
```{r serieswday, cache=TRUE,  fig.width=5, fig.height=4}
data.interval.wdays <-
    data.complete.wdays %>%
