...
```
So the `mean()` of the steps taken is 9354.2295082 while the `median()` is 1.0395\times 10^{4}.
...
## 1      835      206.
```
So the maximum average number of steps is 206.1698113 which is taken in the interval 835.
